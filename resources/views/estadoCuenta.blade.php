...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <!--<div class="card">-->
                <div class=""><img src={{asset('imagenes/logo_alex.png')}} alt="Fjords" style="width:10%" class="img-fluid2"><label class="col-form-label"> {{ __('SELECCIONA TU PERFIL') }}</label></div>
